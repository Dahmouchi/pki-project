...
export default function CertificateValidator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4 bg-cover"  style={{backgroundImage:"url(/bg-2.png)"}}>
